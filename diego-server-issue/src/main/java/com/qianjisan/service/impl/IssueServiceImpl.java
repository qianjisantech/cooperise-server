...
import com.qianjisan.common.context.UserContext;
import com.qianjisan.common.context.UserContextHolder;
import com.qianjisan.common.request.WorkSpaceIssueRequest;
import com.qianjisan.common.request.WorkspaceIssueQueryRequest;
import com.qianjisan.common.util.IssueNoGenerator;
import com.qianjisan.common.vo.PageVO;
import com.qianjisan.common.vo.WorkspaceIssueDetailVO;
import com.qianjisan.common.vo.WorkspaceIssuePageVO;
import com.qianjisan.entity.Issue;
import com.qianjisan.mapper.IssueMapper;
import com.qianjisan.service.IIssueService;
...
public class IssueServiceImpl extends ServiceImpl<IssueMapper, Issue> implements IIssueService {
     ...
     * @return 查询条件包装器
     */
    private LambdaQueryWrapper<Issue> buildQueryWrapper(WorkspaceIssueQueryRequest request) {
     ...
     * @return PageVO对象
     */
    private WorkspaceIssuePageVO convertToVO(Issue entity) {
