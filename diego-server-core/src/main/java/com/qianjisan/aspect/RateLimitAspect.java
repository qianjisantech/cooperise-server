package com.qianjisan.aspect;

import com.qianjisan.annotation.RateLimit;
import com.qianjisan.config.RateLimitProperties;
import com.qianjisan.enums.LimitType;
import com.qianjisan.exception.RateLimitException;
import com.qianjisan.utils.IpUtils;
...
public class RateLimitAspect {
    ...
    private LimitParams parseLimitParams(RateLimit rateLimit) {
        ...
        if (configKey != null && !configKey.isEmpty()) {
            RateLimitProperties.LimitConfig specialConfig = rateLimitProperties.getSpecialConfig(configKey);
        ...
        RateLimitProperties.LimitConfig defaultConfig = getDefaultConfigByType(limitType);
     ...
     * 根据限流类型获取默认配置
     */
    private RateLimitProperties.LimitConfig getDefaultConfigByType(LimitType limitType) {
