...
public class GlobalExceptionHandler {
     ...
     * 当用户访问无权限的数据时抛出
     */
    @ExceptionHandler(com.dcp.common.exception.DataPermissionException.class)
    @ResponseStatus(HttpStatus.FORBIDDEN)
    public Result<?> handleDataPermissionException(com.dcp.common.exception.DataPermissionException e, HttpServletRequest request) {
        String requestUri = request.getRequestURI();
        String method = request.getMethod();
        String ip = getClientIp(request);
