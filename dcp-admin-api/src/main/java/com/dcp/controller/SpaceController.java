 ...
 * @since 2024-12-20
 */
@Tag(name = "空间管理", description = "空间相关接口")
@RestController
...
public class SpaceController {
    ...
    public Result<Void> update(@PathVariable Long id, @RequestBody SpaceRequest request) {
        log.info("[更新空间] ID: {}, 请求参数: {}", id, request);
