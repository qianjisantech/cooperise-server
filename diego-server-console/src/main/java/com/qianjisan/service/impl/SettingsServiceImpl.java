...
import com.qianjisan.exception.BusinessException;
...
import com.qianjisan.util.PasswordUtil;
import com.qianjisan.vo.LoginLogVO;
import com.qianjisan.vo.PageVO;
import com.qianjisan.vo.UserSettingsGroupedVO;
import com.qianjisan.vo.UserSettingsResponseVO;
import com.qianjisan.entity.SysLoginLog;
import com.qianjisan.system.entity.SysUser;
import com.qianjisan.entity.SysUserSettings;
import com.qianjisan.mapper.SysLoginLogMapper;
import com.qianjisan.system.mapper.SysUserMapper;
import com.qianjisan.mapper.UserSettingsMapper;
import com.qianjisan.service.ISettingsService;
...
public class SettingsServiceImpl implements ISettingsService {
    ...
    public PageVO<LoginLogVO> getLoginLogs(Long userId, Long current, Long size) {
        ...
        Page<SysLoginLog> entityPage = sysLoginLogMapper.selectPage(page, wrapper);
