package qianjisan.controller;

import com.qianjisan.common.Result;
import com.qianjisan.common.annotation.RequiresPermission;
import com.qianjisan.common.dto.FeedbackQueryDTO;
import com.qianjisan.common.vo.FeedbackPageVo;
import com.qianjisan.common.vo.FeedbackVO;
import com.qianjisan.entity.Feedback;
import com.qianjisan.entity.FeedbackComment;
import com.qianjisan.service.IFeedbackService;
...
public class FeedbackController {
    ...
    @RequiresPermission("feedback:view")
    @PostMapping("/page")
    public Result<FeedbackPageVo<FeedbackVO>> page(@RequestBody FeedbackQueryDTO query) {
        try {
            Long currentUserId = UserContextHolder.getUserId();
